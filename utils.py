...
# Setting OpenAI API key from environment variables
...
# Category creation with corrected syntax
def create_categories():
    categories_dict = {
      'Billing': [
                ...
                'Dispute a charge'],
      'Technical Support':[
                'General troubleshooting', # Missing comma added
                'Device compatibility', # Missing comma added
                'Software updates'],
      'Account Management':[
                'Password reset', # Missing comma added
                'Update personal information',
                'Close account',
                'Account security'],
      'General Inquiry':[
                'Product information', # Missing comma added
                'Pricing',
                'Feedback',
                'Speak to a human']
    }
...
# Helper functions to read/write product and category data
def get_categories():
...
# Find category and product from user input
...
# Query products from user input
...
# Example usage:
#user_msg = "Do you sell CineView 4K TV?"
#category_and_product_list = get_products_from_query(user_msg)
